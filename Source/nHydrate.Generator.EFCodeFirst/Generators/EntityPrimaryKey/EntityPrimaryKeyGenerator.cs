...
using Widgetsphere.Generator.EFCodeFirst.Generators.EFCSDL;
...
{
	[GeneratorItemAttribute("EntityPrimaryKeyGenerator", typeof(EntityPrimaryKeyExtenderGenerator))]
	class EntityPrimaryKeyGenerator : EFCodeFirstProjectItemGenerator
	{
