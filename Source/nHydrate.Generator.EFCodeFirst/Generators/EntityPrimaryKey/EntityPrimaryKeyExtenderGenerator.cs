...
{
	[GeneratorItemAttribute("EntityPrimaryKeyExtenderGenerator", typeof(EFCodeFirstProjectGenerator))]
	public class EntityPrimaryKeyExtenderGenerator : EFCodeFirstProjectItemGenerator
	{
