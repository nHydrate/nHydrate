...
namespace nHydrate.Generator.SQLInstaller.ProjectItemGenerators
{
    internal static class Globals
    {
        ...
        public static void AppendCreateAudit(Table table, ModelRoot model, StringBuilder sb)
        {
            ...
            sb.AppendLine($"ALTER TABLE [{table.GetSQLSchema()}].[{table.DatabaseName}] ADD [{model.Database.CreatedDateColumnName}] [DateTime2] CONSTRAINT [{dfName}] DEFAULT {model.GetSQLDefaultDate()} NULL");
            sb.AppendLine("GO");
            sb.AppendLine();
        }
        ...
        public static void AppendModifiedAudit(Table table, ModelRoot model, StringBuilder sb)
        {
            ...
            sb.AppendLine($"ALTER TABLE [{table.GetSQLSchema()}].[{table.DatabaseName}] ADD [{model.Database.ModifiedDateColumnName}] [DateTime2] CONSTRAINT [{dfName}] DEFAULT {model.GetSQLDefaultDate()} NULL");
            sb.AppendLine("GO");
            sb.AppendLine();
        }
