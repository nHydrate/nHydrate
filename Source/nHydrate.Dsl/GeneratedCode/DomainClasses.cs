...
namespace nHydrate.Dsl
{
	...
	public abstract partial class nHydrateModelBase : DslModeling::ModelElement, System.ComponentModel.INotifyPropertyChanged
	{
		...
		protected override void MergeRelate(DslModeling::ModelElement sourceElement, DslModeling::ElementGroup elementGroup)
		{
			...
			global::nHydrate.Dsl.ModelMetadata sourceModelMetadata4 = sourceElement as global::nHydrate.Dsl.ModelMetadata;
		...
		protected override void MergeDisconnect(DslModeling::ModelElement sourceElement)
		{
			...
			if (sourceModelMetadata4 != null)
			{
				...
				foreach (DslModeling::ElementLink link in global::nHydrate.Dsl.nHydrateModelHasModelMetadata.GetLinks((global::nHydrate.Dsl.nHydrateModel)this, sourceModelMetadata4))
				{
					// Delete the link, but without possible delete propagation to the element since it's moving to a new location.
